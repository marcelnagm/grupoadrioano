                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            @if (Auth::user()->isAdmin())
                                <a href="{{ route('type-operations.index') }}" class="btn btn-success btn-sm float-right"
                                    data-placement="left">
                                    {{ __('List Operations Types') }}
                                </a>
                            @endif
                        </div>
                    </div>
                                        ...
                                        <td>
                                            <form action="{{ route('statements.destroy', $statement->id) }}" method="POST">
                                                <a class="btn btn-sm btn-primary "
                                                    href="{{ route('statements.show', $statement->id) }}"><i
                                                        class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                <a class="btn btn-sm btn-success"
                                                    href="{{ route('statements.edit', $statement->id) }}"><i
